...
func (s *workOrderHandlerUseCasesStub) ListArchivedWorkOrders(context.Context, int, int, domain.ArchivedWorkOrderFilter) ([]domain.WorkOrderListElement, int64, error) {
	return nil, 0, nil
}
