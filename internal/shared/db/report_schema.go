...
func DashboardView(name string) string {
	return reportSchema() + ".dashboard_" + name
}
...
func InvestorView(name string) string {
	return reportSchema() + ".investor_" + name
}
