-- ========================================
-- MIGRATION 000130 V4 REPORT VIEWS (UP)
-- ========================================
...
SELECT
  ...
  SUM(seeded_area_ha)::numeric AS superficie_sembrada_ha,
...
-- Vista v4 para listado de workorders con insumos
...
-- Vista de consumos de insumos por proyecto
