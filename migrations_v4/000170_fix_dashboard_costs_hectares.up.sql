-- ========================================
-- MIGRATION 000170 FIX DASHBOARD COSTS HECTARES (UP)
-- ========================================
-- Fix: "Avance de costos" usaba seeded_area_ha (área sembrada) como denominador
-- en vez de hectares (superficie nominal). Esto generaba inconsistencia con
-- "Costo u$/Ha" de la incidencia de costos por cultivo que usa hectares.
