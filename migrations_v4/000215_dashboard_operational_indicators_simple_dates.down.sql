-- ========================================
-- MIGRATION 000215 DASHBOARD OPERATIONAL INDICATORS SIMPLE DATES (DOWN)
-- ========================================
...
DROP FUNCTION IF EXISTS v4_ssot.last_manual_stock_entry_date_for_project(p_project_id bigint);
