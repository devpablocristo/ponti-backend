-- ===================================================
-- MIGRATION 000200 RECONCILE WORK ORDER DRAFTS SCHEMA
-- ===================================================
-- Repara entornos donde schema_migrations quedo en 199
-- pero las tablas de work order drafts no existen.
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_customer'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_project'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_campaign'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_field'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_lot'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_crop'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_labor'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_drafts_investor'
    ) THEN
        ALTER TABLE public.work_order_drafts
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_draft_items_draft'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_draft_items_supply'
    ) THEN
        ALTER TABLE public.work_order_draft_items
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_draft_investor_splits_draft'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'fk_work_order_draft_investor_splits_investor'
    ) THEN
        ALTER TABLE public.work_order_draft_investor_splits
