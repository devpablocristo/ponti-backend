-- ========================================
-- MIGRATION 000222 LOT HARVEST FROM WORKORDERS (DOWN)
--
-- Restaura v4_calc.lot_base_costs a la versión definida en 000219
-- (cálculo teórico de harvested_area vía v4_core.harvested_area)
-- y v4_report.lot_list a la versión definida en 000140
-- (lot_harvest_date = NULL::date).
-- ========================================
