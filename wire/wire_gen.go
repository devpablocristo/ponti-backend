...
func Initialize() (*Dependencies, error) {
	...
	dataIntegritySupplyGormEnginePort := ProvideSupplyGormEnginePort(repository)
	dataIntegritySupplyRepository := ProvideSupplyRepository(dataIntegritySupplyGormEnginePort)
	dataintegritySupplyRepositoryPort := ProvideDataIntegritySupplyRepositoryPort(dataIntegritySupplyRepository)
	dataIntegrityProjectGormEnginePort := ProvideProjectGormEnginePort(repository)
	dataIntegrityProjectRepository := ProvideProjectRepository(dataIntegrityProjectGormEnginePort)
	dataintegrityProjectRepositoryPort := ProvideDataIntegrityProjectRepositoryPort(dataIntegrityProjectRepository)
