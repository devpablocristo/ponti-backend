...
Work orders reference project, field, lot, crop, labor, investor, and work order items. Items reference supplies. Work order investor splits can allocate work order participation and payment status. Archived work order listing reads paginated soft-deleted work orders from the base `workorders` table instead of reporting views.
