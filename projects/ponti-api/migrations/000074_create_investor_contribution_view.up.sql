-- ========================================
-- MIGRACIÓN 000074: CREAR VISTA DE APORTES DE INVERSORES
-- Entidad: investor (Crear vista para datos de aportes de inversores)
-- Funcionalidad: Vista unificada para reportes de aportes de inversores
-- ========================================
