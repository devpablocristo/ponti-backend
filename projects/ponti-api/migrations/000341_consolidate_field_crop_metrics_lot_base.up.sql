-- =============================================================================
-- MIGRACIÓN 000341: Consolidar lot_base de field_crop_metrics en v4_calc (UP)
-- =============================================================================
--
-- Propósito: Eliminar duplicación de lot_base en field_crop_metrics.
-- Enfoque: Crear v4_calc.field_crop_metrics_lot_base y reutilizarlo.
-- Nota: Comentarios en español, código en inglés.
--
BEGIN;

-- 1) v4_calc.field_crop_metrics_lot_base (fuente única)
...
COMMENT ON VIEW v4_calc.field_crop_metrics_lot_base IS
'Base única para field_crop_metrics (incluye nombres y métricas por lote).';

-- 2) field_crop_metrics: usa v4_calc.field_crop_metrics_lot_base
