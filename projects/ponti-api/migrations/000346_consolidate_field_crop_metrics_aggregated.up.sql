-- =============================================================================
-- MIGRACIÓN 000346: Consolidar aggregated base de field_crop_metrics en v4_calc (UP)
-- =============================================================================
--
-- Propósito: Centralizar agregados de superficies, producción y precios.
-- Enfoque: Crear v4_calc.field_crop_metrics_aggregated y reutilizarlo.
-- Nota: Comentarios en español, código en inglés.
--
BEGIN;

-- 1) v4_calc.field_crop_metrics_aggregated (fuente única)
...
COMMENT ON VIEW v4_calc.field_crop_metrics_aggregated IS
'Agregados de superficies, producción y precios para field_crop_metrics.';

-- 2) field_crop_metrics: usa v4_calc.field_crop_metrics_aggregated
