-- ========================================
-- MIGRATION 000153: REMOVE ALL ROUND FUNCTIONS FROM SQL (UP)
-- ========================================
-- 
-- Purpose: Eliminar TODOS los ROUND() de las vistas y funciones SQL para mantener precisión completa
-- Date: 2025-01-27
-- Author: System
-- 
...
-- ========================================
-- VISTA v3_dashboard_crop_incidence SIN REDONDEO
-- ========================================
-- Nota: Eliminar redondeo para mantener precisión completa
...
crop_percentages AS (
  SELECT 
    ...
    bc.crop_name,
    bc.crop_hectares,
    -- SIN REDONDEO: mantener precisión completa
    v3_calc.safe_div(bc.crop_hectares, pt.total_project_hectares) * 100 AS crop_incidence_pct
  FROM by_crop bc
    ...
    CASE 
      WHEN tp.total_pct > 99 THEN
        ...
        CASE 
          ...
          ) THEN 100 - (tp.total_pct - cp.crop_incidence_pct)
...
SELECT
  ...
  -- SIN REDONDEO: usar función SSOT para costo directo por hectárea del cultivo
