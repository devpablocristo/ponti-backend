-- =============================================================================
-- MIGRACIÓN 000348: Consolidar costos de insumos en dashboard (DOWN)
-- =============================================================================
--
-- Propósito: Revertir dashboard_management_balance a definición previa (000325)
-- y eliminar vistas v4_calc de soporte.
