-- ============================================================
-- MIGRATION 000123 V4 ADMIN COST PRORATED VIEWS (UP)
-- ============================================================
-- Nota: SQL en inglés, comentarios en español

BEGIN;

-- Admin cost prorrateado para reportes
...
-- Admin cost por ha (raw) para lotes y dashboard
...
-- Admin cost total para dashboard
...
-- Resultado operativo total con admin_cost por hectárea
...
-- Total invertido con admin_cost por hectárea
...
-- Presupuesto usa admin_cost como referencia original
...
-- Views de reportes usando admin_cost prorrateado
