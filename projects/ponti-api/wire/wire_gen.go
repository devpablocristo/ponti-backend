...
func Initialize() (*Dependencies, error) {
	...
	suggesterEnginePort := ProvideProjectSuggesterEnginePort(pkgsuggesterSuggester)
	projectTableName := ProvideProjectTableName()
	projectColumnName := ProvideProjectColumnName()
	projectSuggester := ProvideProjectSuggester(suggesterEnginePort, projectTableName, projectColumnName)
	suggesterPort := ProvideProjectSuggesterPort(projectSuggester)
