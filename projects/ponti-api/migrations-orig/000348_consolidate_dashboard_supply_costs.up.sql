-- =============================================================================
-- MIGRACIÓN 000348: Consolidar costos de insumos en dashboard (UP)
-- =============================================================================
--
-- Propósito: Centralizar costos ejecutados e invertidos de insumos en v4_calc.
-- Enfoque: Crear vistas v4_calc.dashboard_supply_costs_by_project y
--          v4_calc.dashboard_fertilizers_invested_by_project, reutilizarlas.
-- Nota: Comentarios en español, código en inglés.
--
BEGIN;

-- 1) v4_calc.dashboard_supply_costs_by_project
...
COMMENT ON VIEW v4_calc.dashboard_supply_costs_by_project IS
'Costos ejecutados de insumos por proyecto para dashboard.';

-- 2) v4_calc.dashboard_fertilizers_invested_by_project
...
COMMENT ON VIEW v4_calc.dashboard_fertilizers_invested_by_project IS
'Costos invertidos de fertilizantes por proyecto para dashboard.';

-- 3) dashboard_management_balance: usa vistas v4_calc
