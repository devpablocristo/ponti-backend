-- =============================================================================
-- MIGRACIÓN 000332: Rollback arriendo fijo en dashboard (lease_type_value)
-- =============================================================================
--
-- Propósito: Restaurar cálculo previo basado en lease_type_value
...
COMMENT ON VIEW v4_report.dashboard_metrics IS 'Dashboard metrics migrada a v4_report (rollback 000332).';
