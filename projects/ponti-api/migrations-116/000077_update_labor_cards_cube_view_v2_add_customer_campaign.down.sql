-- ========================================
-- MIGRACIÓN 000077: REVERTIR LABOR_CARDS_CUBE_VIEW_V2
-- Entidad: labor (Revertir customer_id y campaign_id de la vista v2)
-- Funcionalidad: Restaurar vista original sin filtros de cliente y campaña
-- ========================================

-- Revertir labor_cards_cube_view_v2 a su estado original
