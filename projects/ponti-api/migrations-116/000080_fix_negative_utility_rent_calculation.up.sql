-- ========================================
-- MIGRACIÓN 000080: FIX UTILIDAD NEGATIVA EN ARRIENDO POR PORCENTAJE
-- Entidad: views (Corregir base_lease_calculations_view)
-- Funcionalidad: Implementar regla "No se calcula utilidad negativa!" solo para arriendo por % utilidad
-- ========================================
-- Esta migración implementa la regla: "No se calcula utilidad negativa!"
-- Solo afecta el cálculo de arriendo por porcentaje de utilidad (lease_type_id = 2)
-- No modifica otros cálculos del sistema

-- Recrear la vista base_lease_calculations_view con el fix
