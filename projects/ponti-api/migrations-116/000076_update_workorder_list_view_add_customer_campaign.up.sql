-- ========================================
-- MIGRACIÓN 000076: ACTUALIZAR WORKORDER_LIST_VIEW
-- Entidad: workorder (Agregar customer_id y campaign_id a la vista de lista)
-- Funcionalidad: Incluir filtros de cliente y campaña en la vista de lista
-- ========================================

-- Actualizar workorder_list_view para incluir customer_id y campaign_id
