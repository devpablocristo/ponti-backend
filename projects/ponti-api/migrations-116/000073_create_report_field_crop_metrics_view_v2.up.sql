...
-- ========================================
-- Propósito: Vista optimizada para GORM con los mismos cálculos de la 72
-- Incluye: Todos los cálculos del informe por campo/cultivo (reutiliza 72)
-- Filtros: Por proyecto, campo, cultivo, cliente y campaña
-- Optimizada para: GORM mapeo de tipos
-- ========================================

-- Crear la nueva vista optimizada para GORM
