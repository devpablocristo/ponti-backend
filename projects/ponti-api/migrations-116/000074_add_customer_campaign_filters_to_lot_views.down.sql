-- ========================================
-- MIGRACIÓN 000074: REVERTIR FILTROS CUSTOMER Y CAMPAIGN A VISTAS DE LOTES
-- Entidad: views (Revertir vistas de lotes)
-- Funcionalidad: Revertir cambios en las vistas de lotes
-- ========================================
