...
-- TRUNCATE TABLE units RESTART IDENTITY CASCADE; -- Tabla no existe en este esquema
...
-- ALTER SEQUENCE units_id_seq RESTART WITH 1; -- Secuencia no existe en este esquema
