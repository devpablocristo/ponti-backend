...
func (h *Handler) Routes() {
	...
	{
		public.POST("", h.CreateCrop)       // Create a crop
		public.GET("", h.ListCrops)         // List all crops
		public.GET("/:id", h.GetCrop)       // Get a crop by ID
		public.PUT("/:id", h.UpdateCrop)    // Update a crop
		public.DELETE("/:id", h.DeleteCrop) // Delete a crop
	}
