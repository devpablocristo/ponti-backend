-- ========================================
-- MIGRATION 000194 WORKORDER_LIST ADD LABOR ROW (UP)
-- ========================================
-- Agrega una fila de costo de labor por cada workorder en la vista workorder_list.
-- Antes solo mostraba filas de insumos; ahora incluye la labor como una fila mas
-- con type_name='Labor' para que el costo directo total sea correcto.

BEGIN;

CREATE OR REPLACE VIEW v4_report.workorder_list AS
-- Filas de insumos (comportamiento existente)
SELECT
  w.id,
  w.number,
  w.project_id,
