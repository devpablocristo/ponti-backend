-- =============================================================================
-- MIGRACIÓN 000340: Consolidar lot_base de field_crop en v4_calc (UP)
-- =============================================================================
--
-- Propósito: Eliminar duplicación de lot_base entre field_crop_*.
-- Enfoque: Crear v4_calc.field_crop_lot_base y reutilizarlo en vistas.
-- Nota: Comentarios en español, código en inglés.
--
BEGIN;

-- 1) v4_calc.field_crop_lot_base (fuente única)
...
COMMENT ON VIEW v4_calc.field_crop_lot_base IS
'Base única para field_crop_* (project_id, field_id, crop_id, lot_id, surface_ha, sowed_area_ha, tons).';

-- 2) field_crop_labores: usa v4_calc.field_crop_lot_base
...
-- 3) field_crop_insumos: usa v4_calc.field_crop_lot_base
...
-- 4) field_crop_economicos: usa v4_calc.field_crop_lot_base
...
-- 5) field_crop_rentabilidad: usa v4_calc.field_crop_lot_base
