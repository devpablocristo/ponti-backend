-- =============================================================================
-- MIGRACIÓN 000332: Unificar SSOT siembra + per-ha inversor
-- =============================================================================
--
-- Propósito:
-- 1) Sembrado = órdenes de siembra (sin fallback)
-- 2) Informe inversor por ha = surface_total_ha
-- Impacto: lot_metrics, lot_list, dashboard_metrics, investor_contribution_data
-- Nota: Comentarios en español, código en inglés
--

BEGIN;

-- 1) Sembrado = órdenes de siembra (categoría 9)
...
-- 2) Informe inversor por ha usa surface_total_ha
...
'Vista final para informe de Aportes por Inversor. Per-ha usa surface_total_ha (000332).';
