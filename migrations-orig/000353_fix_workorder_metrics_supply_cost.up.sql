-- ========================================
-- MIGRACIÓN 000353: FIX WORKORDER_METRICS SUPPLY COST (UP)
-- ========================================
--
-- Propósito: Alinear workorder_metrics con cálculo histórico (total_used)
-- Usa v4_ssot.supply_cost_for_lot_base en lugar de supply_cost_for_lot
--
...
SELECT
  ...
  v4_ssot.supply_cost_for_lot_base(li.lot_id) AS supplies_cost_usd,
  (v4_ssot.labor_cost_for_lot(li.lot_id) +
   v4_ssot.supply_cost_for_lot_base(li.lot_id)) AS direct_cost_usd,

  v4_core.per_ha(
    v4_ssot.labor_cost_for_lot(li.lot_id) +
    v4_ssot.supply_cost_for_lot_base(li.lot_id),
