    ...
    <div className="flex flex-col md:flex-row gap-4">
      <IndicatorCard
        ...
        value={
          processing
            ? "Cargando..."
            : metrics.surface_ha.toLocaleString("es-AR", {
      ...
      <IndicatorCard
        ...
        value={
          processing
            ? "Cargando..."
            : " u$" +
              metrics.avg_cost_per_ha.toLocaleString("es-AR", {
                maximumFractionDigits: 3,
              })
        }
        color="gray"
      ...
      <IndicatorCard
        ...
        value={
          processing
            ? "Cargando..."
            : " u$" +
              metrics.net_total_cost.toLocaleString("es-AR", {
                maximumFractionDigits: 3,
              })
        }
        color="gray"
  ...
  const columns: Column<TaskData>[] = useMemo(
    () => [
      ...
      },
      {
        ...
        filterable: false,
        render: (value) => (
          <strong className="text-gray-900">{value} Has</strong>
        ),
      },
      {
        key: "cost_ha",
        header: "Costo $/Ha",
        filterable: false,
        render: (value) => <strong className="text-gray-700">${value}</strong>,
      },
      {
        key: "net_total",
        header: "Total $ Neto",
      ...
      { key: "usd_avg_value", header: "u$ Prom", filterable: false },
      { key: "usd_cost_ha", header: "Costo U$/Ha", filterable: false },
      { key: "usd_net_total", header: "Total u$ Neto", filterable: false },
      {
        key: "invoice_number",
        header: "N° Factura",
        filterable: false,
