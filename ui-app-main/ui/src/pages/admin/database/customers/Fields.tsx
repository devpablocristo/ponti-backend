...
export default function Fields({
  ...
  const handleFieldChange = (
    fieldIndex: number,
    fieldKey: "name" | "leaseType" | "leaseTypePercent" | "leaseTypeValue",
    value: string | number
  ) => {
    ...
    <div className="bg-white border border-gray-300 rounded-lg p-6 space-y-4 md:mt-10">
      ...
      {fields.map((field, key) => (
        <div key={key} className="rounded-lg space-y-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:gap-4 md:max-w-2xl md:space-y-1 space-y-3 relative">
            <InputField
              label="Campo"
            ...
            {((typeof field.leaseTypePercent === "number" &&
              ...
              <div className="w-fit flex mt-2 items-center bg-custom-btn text-white text-sm font-sm rounded-full px-4 py-2">
