  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
      <IndicatorCard
        ...
        value={processing ? "Cargando..." : metrics.surface_ha + " Has"}
        color="gray"
        height="85px"
        width="200px"
      />
      <IndicatorCard
        ...
        value={processing ? "Cargando..." : metrics.liters + " Lts"}
        color="gray"
        height="85px"
        width="200px"
      />
      <IndicatorCard
        ...
        value={processing ? "Cargando..." : metrics.kilograms + " Kg"}
        color="gray"
        height="85px"
        width="200px"
      />
      <IndicatorCard
        ...
        value={processing ? "Cargando..." : " u$" + metrics.direct_cost}
        color="gray"
        height="85px"
        width="200px"
      />
...
export function WorkOrders() {
  ...
  const columns: Column<OrdersData>[] = React.useMemo(
    () => [
      ...
      { key: "dose", header: "Dosis", filterable: false },
      {
        key: "cost_per_ha",
        header: "Costo $/HA",
        filterable: false,
        render: (value: any) => {
          ...
          return <strong>{isNaN(num) ? "-" : `u$${num.toFixed(2)}`}</strong>;
        },
      },
    ...
    <div>
      ...
      <div className="mt-4 relative">
        ...
        <DataTable
          ...
          onFilterChange={setColumnsFilters}
