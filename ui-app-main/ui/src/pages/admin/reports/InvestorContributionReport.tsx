...
const contributionRowsToRender: RowToRender[] = [
  {
    ...
    key: "agrochemicals",
    valueFormat: {
      totalInvested: (value) => `u$${ value }`,
      totalPerHa: (value) => `${ value } u$/Ha`,
      investor: (value, percentage) => `u$${ value } - ${ percentage }%`,
    },
  },
  {
    label: "Semilla",
              ...
              <div className="flex justify-between items-center gap-8 mb-4">
                ...
                <div className="flex gap-8">
                  <InputField
                    ...
                    size="sm"
                    value=""
                    placeholder={ `${ reportingData?.general.surface_total_ha ?? "" } Has` }
                  ...
                  <InputField
                    ...
                    size="sm"
                    value=""
                    placeholder={ `u$ ${ reportingData?.general.lease_fixed_usd ?? "" }` }
                  ...
                  <InputField
                    ...
                    size="sm"
                    value=""
                    placeholder={ `u$ ${ reportingData?.general.admin_per_ha_usd ?? "" }` }
